...
class View extends JFrame {
  ...
  private JButton friendlineButton;
  ...
  private class DrawingPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
      ...
      enumeration = model.getmarkformoveItems();
      while (enumeration.hasMoreElements()) {
        ((Item) enumeration.nextElement()).render();
      }
  ...
  public View() {
    super("Drawing Program 1.2  Untitled");
    fileName = null;
    ...
    friendlineButton = new FriendlylineButton(undoManager, this, drawingPanel);
    drawPolygonButton = new DrawpolygonButton(undoManager, this, drawingPanel);
    ...
    buttonPanel.add(friendlineButton);
